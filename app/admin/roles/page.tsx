    ...
    const rolesData: RolePermissions[] = [
      {
        ...
        description: 'Has complete control over the entire portal with unrestricted access to all features and settings.',
      },
      {
        role: 'Center_Leader',
    ...
    try {
      ...
      if (data.success) {
        ...
        setRoles(prev => prev.map(role => {
          ...
          switch (role.role) {
            case 'SUPER_ADMIN':
              count = data.stats.superAdmins;
              break;
            case 'Center_Leader':
              count = data.stats.centerLeaders;
              break;
            case 'Lecturer':
              count = data.stats.lecturers;
              break;
            case 'Student':
              count = data.stats.students;
              break;
            case 'Applicant':
              count = data.stats.applicants;
              break;
          }
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-blue-800 dark:text-blue-400 text-sm">
                ...
                Super Administrators have full access to all system features and can manage all other roles. 
